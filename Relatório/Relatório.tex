...
\begin{figure}[!htb]
\centering
\includegraphics[width=7.5cm]{InterfaceMenuPrincipalFuncionario}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=12cm, height=10cm]{FazerLogin}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=12cm, height=4.5cm]{stockDisponivel}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{ModeloDominioPackages}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{DiagramaClassePackages}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{DiagramaClasseDAOPackages}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{CamadaAplicacional}
