...
\begin{figure}[!htb]
\centering
\includegraphics[width=4cm]{InterfaceAdicionarStock}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=6cm]{InterfaceStockDisponivel}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=5cm]{InterfaceCarroPronto}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=10cm]{InterfaceLogin}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=8cm]{InterfaceRegistar}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=8cm]{InterfaceMenuPrincipal}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{InterfaceComprarCarro}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=7cm]{InterfaceEscolherPacote}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=5cm]{InterfaceConfiguracaoOtima}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=9cm]{InterfaceEscolherEspecificacoes}
...
\begin{figure}[!htb]
\centering
\includegraphics[width=7cm]{InterfaceConfirmarCompra}
