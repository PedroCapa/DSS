...
CREATE TABLE IF NOT EXISTS `ConfiguraFacil`.`Carro` (
  ...
  `Utilizador_idUtilizador` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `ConfiguraFacil`.`Peca_Carro` (
  `Carro_idCarro` VARCHAR(45) NOT NULL,
  `Peca_idPeca` VARCHAR(45) NOT NULL,
  `Colocada` TINYINT NULL,
  INDEX `fk_Peca_Carro_Carro1_idx` (`Carro_idCarro` ASC) VISIBLE,
  INDEX `fk_Peca_Carro_Peca1_idx` (`Peca_idPeca` ASC) VISIBLE,
  ...
  CONSTRAINT `fk_Peca_Carro_Peca1`
    ...
    REFERENCES `ConfiguraFacil`.`Peca` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `ConfiguraFacil`.`Peca_Pacote` (
  `Peca_idPeca` VARCHAR(45) NOT NULL,
  `Pacote_Nome` VARCHAR(45) NOT NULL,
  INDEX `fk_Peca_Pacote_Peca1_idx` (`Peca_idPeca` ASC) VISIBLE,
