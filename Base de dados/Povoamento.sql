...
insert into Peca_Peca 
	VALUES(0, '177 cu in'						, 'Boss 302 V8'						),
          ...
          (0, '385 Engine'						, '177 cu in'						),
          (0, '385 Engine'						, 'Boss 302 V8'						),
          (0, '385 Engine'						, 'V 12'							),
          (0, '385 Engine'						, 'Lynx'							),
		  ...
		  (0, '255 Horsepower 312 Cubic Inch V8', '177 cu in'						),
          (0, '255 Horsepower 312 Cubic Inch V8', 'Boss 302 V8'						),
          (0, '255 Horsepower 312 Cubic Inch V8', '385 Engine'						),
          (0, '255 Horsepower 312 Cubic Inch V8', 'V 12'							),
          (0, '255 Horsepower 312 Cubic Inch V8', 'Lynx'							),
          (0, '255 Horsepower 312 Cubic Inch V8', '2.3 Ecoboost 290cv'				),
          (0, '2.3 Ecoboost 290cv'				, '177 cu in'						),
          (0, '2.3 Ecoboost 290cv'				, 'Boss 302 V8'						),
          (0, '2.3 Ecoboost 290cv'				, '385 Engine'						),
          (0, '2.3 Ecoboost 290cv'				, 'V 12'							),
          (0, '2.3 Ecoboost 290cv'				, 'Lynx'							),
          (0, '2.3 Ecoboost 290cv'				, '2.3 Ecoboost 290cv'				),
          (0, 'Branco'							, 'Vermelho'						),
          (0, 'Branco'							, 'Azul'							),
          (0, 'Branco'							, 'Preto'							),
          (0, 'Vermelho'						, 'Branco'							),
          ...
          (0, 'Couro Alcantara'					, 'Couro Cognac'					),
          (0, 'Couro Alcantara'					, 'Couro Recaro Red'				),
          (0, 'Couro Recaro Red'				, 'Couro Cognac'					),
